...
#Numeric buttons
Button(root, text='1',command=lambda:getnumbers(1)).grid(row=4, column=0,sticky=W+E)
Button(root, text='2',command=lambda:getnumbers(2)).grid(row=4, column=1,sticky=W+E)
Button(root, text='3',command=lambda:getnumbers(3)).grid(row=4, column=2,sticky=W+E)
...
Button(root, text='7',command=lambda:getnumbers(7)).grid(row=2, column=0,sticky=W+E)
Button(root, text='8',command=lambda:getnumbers(8)).grid(row=2, column=1,sticky=W+E)
Button(root, text='9',command=lambda:getnumbers(9)).grid(row=2, column=2,sticky=W+E)
...
Button(root, text = '/',command=lambda:getnumbers('/')).grid(row=5,column=3,sticky=W+E)
...
Button(root, text = '=',command=lambda:operation()).grid(row=5,column=4,sticky=W+E, columnspan=2)
